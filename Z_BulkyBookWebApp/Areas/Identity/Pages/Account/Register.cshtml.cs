...
namespace Z_BulkyBookWebApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // to create a role for first time
                    ...
                    if (user.Role == null) // if not login with admin, default role will be Indi
                    {
